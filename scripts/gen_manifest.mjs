/* 🧬 S-DNA: AOI-2026-0214-X402-COMMERCE-01 | module: gen_manifest | owner: Aoineco */
...
const sdna = process.env.SDNA_ID || 'AOI-2026-0214-X402-COMMERCE-01';
const repo = process.env.REPO_URL || 'https://github.com/edmonddantesj/7-dollar-bootstrap-x402';
